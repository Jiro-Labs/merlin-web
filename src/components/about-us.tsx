            ...
            <div className="mx-[5%]">
                <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-16 xl:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 flex justify-start">
                        <div className="relative w-[100%] lg:w-full max-w-md lg:max-w-full">
                            <Image
                    ...
                    <div className="w-full lg:w-1/2 text-white text-left lg:pt-8 xl:pt-12">
                        <p className="text-lg sm:text-xl lg:text-2xl font-bold">
                            {title}
                        </p>
                        <p className="my-3 text-2xl sm:text-3xl lg:text-4xl font-bold">
                            {subtitle}
                        </p>
