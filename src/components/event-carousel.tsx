    ...
    return (
        <CarouselItem className="pl-2 sm:pl-3 md:pl-4 basis-4/5 sm:basis-1/2 lg:basis-1/3">
            <div className="w-full aspect-[4/3] relative rounded-lg overflow-hidden group">
                ...
                <div
                    className="h-2/5 sm:h-2/5 md:h-1/3 absolute inset-0 top-auto bottom-2 sm:bottom-1 lg:bottom-1 bg-gradient-to-t from-purple-600/70 via-purple-500/30 to-transparent opacity-80 pointer-events-none"
                    style={{
                        background:
