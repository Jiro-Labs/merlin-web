        ...
        <div className="px-4 sm:px-6 lg:px-10 pt-6 sm:pt-8 lg:pt-10 pb-12 sm:pb-16 lg:pb-20">
            ...
            <div className="md:mx-[5%]">
                <div className="flex flex-col xl:flex-row xl:justify-between gap-8 xl:gap-12">
                    ...
                    <div className="w-full xl:flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-0 place-items-center md:place-items-stretch">
                            ...
                            >
                                <div className="text-center md:text-left">
                                    <FeatureCardTitle>Marketing Services</FeatureCardTitle>
                                    <ul className="list-disc pl-5 text-sm sm:text-base text-left md:text-left">
                ...
                <div className="w-full xl:max-w-md 2xl:max-w-lg xl:mt-60 text-white text-center xl:text-left">
                    <p className="text-xl sm:text-2xl xl:text-2xl font-bold">{title}</p>
                    <p className="my-3 text-2xl sm:text-3xl xl:text-4xl font-bold">{subtitle}</p>
                    <p className="my-4 sm:my-5 text-sm sm:text-base xl:text-base text-gray-500 leading-relaxed">{description}</p>
